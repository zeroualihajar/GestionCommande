...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
	  ...
	  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/client.jpg')">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
         <form method="post" action="ClientCon">
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              ...
              <input type="email" class="form-control" placeholder="Email Address" type="email" name="email"required data-validation-required-message="Please enter your email address.">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="control-group">
            <div class="form-group col-xs-12 floating-label-form-group controls">
              <label>Adress</label>
              <input type="text" class="form-control" placeholder="Adress" type="text" name="adress" required data-validation-required-message="Please enter your adress">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <br>
		...
		<tr>
			...
			<td><a href="Details?id=${client.getIdClient()}">Show</a></td>
			<td><a href="Commander?id=${client.getIdClient()}">Commander</a>
		</tr>	
		</c:forEach>
